...
<html lang="pt-br">
  ...
  <div class="d-flex flex-wrap justify-content-center align-items-start flex-column">
      ...
      <div class="caixa w-100">
          <div>
              <a href="../materia_prima/materia_prima_criar.php" class="btn btn-lg btn-outline-dark">  
              Adicionar 
          ...
          <div>
            <a href="../materia_prima/materia_prima_consultar.php" class="btn btn-lg btn-outline-dark">  
            Consultar
          ...
          <div>
              <a href="../materia_prima/materia_prima_atualizar.php" class="btn btn-lg btn-outline-dark">  
              Atualizar
          ...
          <div>
            <a href="../materia_prima/materia_prima_deletar.php" class="btn btn-lg btn-outline-dark">  
            Deletar
