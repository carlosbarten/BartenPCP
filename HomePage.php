  ...
  <main class="container">
    <div class="d-flex flex-wrap justify-content-center align-items-start flex-column">
        <div class="w-100 my-4 mt-0">
          <h1 class="titulo text-center">Módulos</h1>
        </div>
  
        <div class="caixa w-100">
            <div>
                <a href="./producao/producao.php" class="btn btn-lg btn-outline-dark">  
                Produção 
                <img class="mt-3" src="/img/producao.png"/>
              </a>
            </div>
  
            <div>
              <a href="./receitas/receitas.php" class="btn btn-lg btn-outline-dark">  
              Receitas
              <img class="mt-3" src="/img/Receita.png"/>
            </a>
            </div>
          
            <div>
                <a href="./estoque/estoque.php" class="btn btn-lg btn-outline-dark">  
                Estoque
                <img class="mt-3" src="/img/estoque.png" />
              </a>
            </div>
  
            <div>
              <a href="./pedidos/pedidos.php" class="btn btn-lg btn-outline-dark">  
              Pedidos
              <img class="mt-3" src="/img/pedido.png" />
            </a>
            </div>
        </div>
    </div>
