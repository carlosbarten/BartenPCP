...
if(isset($_POST["botao_atualizar"])){
  ...
  $lote = $_POST["lote"];
  $sql = "UPDATE lote SET lote ='$lote',OG_prod = '$og', FG_prod = '$fg', data_prod = '$data_producao', rendimento = '$rendimento', data_final_fermentacao = '$fim_fermentacao', data_final_maturacao = '$fim_maturacao' WHERE lote = '$nome_atualizar'";
  $stmt = $pdo->prepare($sql);
  $stmt->execute();
  if($stmt->rowCount() > 0){
...
<html lang="pt-br">
  <head>
    ...
    <title>Produção - Atualziar</title>
    ...
    <div class="d-flex flex-wrap mt-3 flex-column">
      ...
      <div class="infos">
        ...
        <div class="container-fluid mt-3">
          <input class="btn btn-lg btn-primary" type="submit" name="botao_atualizar" id="botao_atualizar" style="background-color: green; border: green;" value="Salvar">
        </div>
